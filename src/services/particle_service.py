...
TABLE_COLUMN_NAMES = ["tag" , "aligned" , "averaged" , "dx" , "dy" , "dz" , "tdrot" , "tilt" , "narot" , "cc" , "cc2" , "cpu" , "ftype" , "ymintilt" , "ymaxtilt" , "xmintilt" , "xmaxtilt" , "fs1" , "fs2" , "tomo" , "reg" , "class" , "annotation" , "x" , "y" , "z" , "dshift" , "daxis" , "dnarot" , "dcc" , "otag" , "npar" , "ref" , "sref" , "apix" , "def" , "eig1" , "eig2"]
...
class ParticleService:
  ...
  def _read_dynamotable(self, filename):
    particles_df = pd.read_csv(filename, sep='\\s+', header=None, names=TABLE_COLUMN_NAMES)
    return particles_df
